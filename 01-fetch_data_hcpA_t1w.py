...
data_folder = '/data/hzb/project/Brain_Predict_Score/HCPA/T1w_data_preprocess/HCPA_pcp/Gordon/filt_noglobal/'
...
def main():
    ...
    time_series = Reader.get_timeseries_hcpa_t1(subject_IDs, atlas)
