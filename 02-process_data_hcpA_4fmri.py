...
import pandas as pd
import numpy as np
from imports import preprocess_data_hcpA as Reader
...
# data_folder = '/data/hzb/project/Brain_Predict_Score/data_hcp_4fmri/HCP_pcp/Gordon/filt_noglobal/'

data_folder = '/data/hzb/project/Brain_Predict_Score/HCPA/data_preprocess_fmri_4/HCPA_pcp/Gordon/filt_noglobal/'
...
def main():
    ...
    labels = Reader.get_subject_score_4fmri(subject_IDs, score='interview_age')   #Gender
